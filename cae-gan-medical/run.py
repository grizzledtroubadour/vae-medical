...
def main(args):
    ...
    _, dataset_pc = get_datasets(options, dataset=dataset)
    config = get_config(
        trainer=trainer,
        options=options,
...
if __name__ == '__main__':
    ...
    args.add_argument('-d', '--ds', default=Dataset.MSISBI2015, type=Dataset, help='Only evaluate on given dataset')
